    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 flex items-center justify-center p-4">
      <div className="flex w-full max-w-5xl bg-white rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="w-full md:w-1/2 p-8 lg:p-14">
          <h1 className="text-4xl lg:text-5xl font-semibold text-gray-800">Bienvenido</h1>
          ...
          <form className="mt-8 space-y-6">
            <div>
              <label className="text-lg font-medium text-gray-700">Correo</label>
              <input
            ...
            <div>
              <label className="text-lg font-medium text-gray-700">Contraseña</label>
              <input
                className="w-full border-2 border-gray-300 rounded-xl p-4 mt-1 bg-transparent focus:border-violet-500 focus:ring-2 focus:ring-violet-200 transition-all duration-300 outline-none"
                placeholder="••••••••"
                type="password"
            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-2">
                <input type="checkbox" id="recuerdame" className="w-4 h-4 text-violet-600 rounded" />
                <label htmlFor="recuerdame" className="font-medium text-base text-gray-700">Recuérdame</label>
              </div>
              <button type="button" className="font-medium text-base text-violet-600 hover:text-violet-700 transition">
